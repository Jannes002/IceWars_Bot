...
from .building_names import BUILDING_NAMES, building_display_name  # noqa: F401 (re-exported)
...
# BUILDING_NAMES und building_display_name sind in building_names.py definiert
# und werden oben via Import bereitgestellt (re-export für Rückwärtskompatibilität).
